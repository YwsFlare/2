...
menu_button::menu_button(menuwindow *parent):QPushButton(parent){
    ...
    sound->setSource(QUrl::fromLocalFile("D:\\project1\\carrots\\button_press.wav"));//必须绝对路径
    this->setFlat(true);
    ...
    : QMainWindow{parent}
{
    ...
    music->setSource(QUrl::fromLocalFile("D:\\project1\\carrots\\menu_bg_music.wav"));//必须绝对路径
