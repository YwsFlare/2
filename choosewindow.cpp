...
cho_button3::cho_button3(choosewindow *parent):QPushButton(parent){
    ...
    sound->setSource(QUrl::fromLocalFile("D:\\project1\\carrots\\cho_btn_move.wav"));//必须绝对路径
    this->setFlat(true);
...
int choosewindow::btnEnter(QPoint pp){//可以优化，重复率太高
    ...
    : QMainWindow{parent}
{
    ...
    sound->setSource(QUrl::fromLocalFile("D:\\project1\\carrots\\choosewindow_BGMusic.wav"));//必须绝对路径
